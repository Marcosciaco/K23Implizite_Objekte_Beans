...
<title>Logged in: Last messages</title>
<style type="text/css">
table {
	width: 100%;
}
...
<body>
	...
	<table>
		<tr>
			...
			<td style="text-align: right;">Number of Messages: <%=meldungsliste.getAnzahlMeldungen()%><br>
				You are loged in as <b><%=request.getRemoteUser()%></b><br>
	...
	<table>
		<tr>
			...
			<td style="text-align: right;">
				...
				%> <a
				href="http://localhost:8081/K23Implizite_Objekte_Beans/sec2/index.jsp?zaehler=<%=zaehler + meldungsliste.getAnzahlZuLiefernderMeldungen()%>">&lt&ltVorige&nbsp</a>
				<%
						}
						if (zaehler - meldungsliste.getAnzahlZuLiefernderMeldungen()+1 > 0) {
				%> <a
				href="http://localhost:8081/K23Implizite_Objekte_Beans/sec2/index.jsp?zaehler=<%=zaehler - meldungsliste.getAnzahlZuLiefernderMeldungen()%>">&nbspWeitere&gt&gt</a>
				<%
						}
					} else {
				%> <a
				href="http://localhost:8081/K23Implizite_Objekte_Beans/sec2/index.jsp?zaehler=<%=meldungsliste.getAnzahlMeldungen()-1%>">&nbspWeitere&gt&gt</a>
				<%
					}
				%>
			</td>
	...
	<table border="5pt solid">
		...
		<tr>
			...
			<td><a
				href="http://localhost:8081/K23Implizite_Objekte_Beans/sec2/OldMessage.jsp?id=<%=zaehler-i%>"><%=meldungsliste.getMeldung(zaehler-i).getKurzTitel()%>(von
